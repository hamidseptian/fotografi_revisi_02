...
<html lang="zxx">
<head>
	<title>Glowing Art Studio</title>
	<meta charset="UTF-8">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="user-panel pull-right">
							<div class="up-item">
								<?php if (isset($_SESSION['level'])=='Pelanggan') { ?>
								<a href="logout.php" class="btn btn-info" style="float: right;">Logout</a>
								<p  style="float: right; margin-right: 24px; margin-top: 7px"><i class="fa fa-user"></i> <?php echo $dpel['nama_pelanggan'] ?> </p>
								<?php } else{ ?>
								<a href="?m=register" class="btn btn-info">Register</a>
								<a href="?m=login" class="btn btn-info">Login</a>
							<?php } ?>
							</div>
						</div>
					</div>
		...
		<nav class="main-navbar">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="#">Jasa Kami</a>
						<ul class="sub-menu">
							<li><a href="?m=jasa">Biaya Jasa</a></li>
							<!-- <li><a href="?m=carapesan">Cara Pesan</a></li> -->
						</ul>
					</li>
					<li><a href="#">Gelery</a>
						<ul class="sub-menu">
							<li><a href="?m=galeri">Galery Glowing Art Studio</a></li>
							<?php if (isset($_SESSION['level'])=='Pelanggan') { ?>
							<li><a href="?m=myfoto">Galery History Foto Saya</a></li>
						<?php } ?>
						</ul>
					</li>
					<!-- <li><a href="#">Order</a></li> -->
					<?php if (isset($_SESSION['level'])=='Pelanggan') { ?>
					<li><a href="?m=booking">Booking</a></li>
							<li><a href="?m=keranjang">Keranjang</a></li>
					<!-- <li><a href="#">Keranjang</a>
						<ul class="sub-menu">
							<li><a href="?m=keranjang">Keranjang Cetak</a></li>
							<li><a href="?m=keranjang_book">Keranjang Booking</a></li>
						</ul>
						
					</li> -->
					<li><a href="?m=history">Riwayat Pesanan</a></li>
							<li><a href="?m=editakun">Edit Akun</a></li>
